...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			colors: ['#be1e2d','#666699','#92d5ea','#ee8310','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744','#ff00ff','#ff0000','#ededed', '#b400ff', '#ed09f5', '#f75d09', '#9c9e06', '#3f7b05', '#057b69', '#054d7b', '#05057b', '#85391f', '#053713', '#16ebbb', '#740142', '#ef8ec5', '#cbbdea', '#fb04c4'],
